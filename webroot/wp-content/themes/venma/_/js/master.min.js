...
var novicell=novicell||{};novicell.overlay=new function(){this.set=function(e){0<$("#ncOverlay").length&&$("#ncOverlay,#ncOverlay-content").remove();var n=$("<a>").attr("href","#closeOverlay").addClass("ncOverlay-close").append($("<span>")),c=$("<div>").addClass("ncOverlay-inner").append($("<div>").addClass("ncOverlay-inner-scroll").append(e.content));$("body").append($("<div>").attr("id","ncOverlay").fadeIn("fast")),$("body").append($("<div>").attr("id","ncOverlay-content").append(n).append(c).fadeIn("fast",function(){"function"==typeof e.callbackOpen&&e.callbackOpen()})),$("#ncOverlay").height($("body").height()),void 0!=e["class"]&&$("#ncOverlay-content").addClass(e["class"]),$("#ncOverlay-content").css({"margin-top":(document.documentElement&&document.documentElement.scrollTop||document.body.scrollTop)+40}),$("#ncOverlay,.ncOverlay-close").on("click",function(n){n.preventDefault(),$("#ncOverlay-content").stop().fadeOut("fast",function(){$(this).remove()}),$("#ncOverlay").stop().fadeOut("fast",function(){$(this).remove(),"function"==typeof e.callbackClose&&e.callbackClose()})}),$(document).keyup(function(e){27==e.keyCode&&$(".ncOverlay-close").click()})}};
...
if(navigator.userAgent.match(/Windows NT 6.2; ARM(.+)Touch/)){var msViewportStyle=document.createElement("style");msViewportStyle.appendChild(document.createTextNode("@-ms-viewport{width:device-width}")),document.getElementsByTagName("head")[0].appendChild(msViewportStyle)}
$(function(){venma.navigation.init(),venma.hero.init(),venma.header.init()});var venma=venma||{};venma.navigation=venma.navigation||new function(){var e=this;this.init=function(){e.initializeMobileNavigation()},this.initializeMobileNavigation=function(){$("body").on("click",".toggle-menu, #off-canvas-overlay",function(e){return e.preventDefault(),$(this).blur(),$("#off-canvas-panel").toggleClass("panel-open"),$("#off-canvas, #site").toggleClass("off-canvas-active"),!1})}},venma.hero=venma.hero||new function(){var e=this;this.init=function(){e.flexslider("#content-hero .hero-slider-wrapper")},this.flexslider=function(e){$(e).flexslider({animation:"slide",slideshow:!0,selector:".hero-slider > li",namespace:"hero-slider-",pauseOnAction:!1,pauseOnHover:!0})}},venma.header=venma.header||new function(){this.init=function(){$("#page").data("size","big")},$(window).scroll(function(){$(document).scrollTop()>110?"big"==$("#page").data("size")&&($("#page").data("size","small"),$("#page").addClass("scroll")):"small"==$("#page").data("size")&&($("#page").data("size","big"),$("#page").removeClass("scroll"))})};