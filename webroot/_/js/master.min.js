...
$(function(){project.navigation.init(),console.log("Project Running Smooth!")});var project=project||{};project.navigation=project.navigation||new function(){var i=this;this.init=function(){i.initializeMobileNavigation()},this.initializeMobileNavigation=function(){$("body").on("click",".toggle-menu",function(i){return i.preventDefault(),$(this).blur(),$("body").toggleClass("menu-open"),!1})}};